"""
Django settings for the e-bnk project.
...
# Load .env located one level up (inside backend/)
...
# Custom user model
AUTH_USER_MODEL = "ebnk_models.User"
